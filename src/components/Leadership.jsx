...
const LEADERS = site.leadership.leaders;
    ...
    <div className="relative aspect-[4/5] w-full overflow-hidden bg-usf-blue">
      ...
      <div className="absolute inset-0 grid place-items-center">
        <div className="relative">
          <div className="font-display text-[56px] font-light leading-none tracking-[-0.04em] text-white/85 sm:text-[72px] md:text-[88px]">
            {initials}
          </div>
      ...
      <div className="container-usf">
        <div className="grid items-end gap-8 border-b border-usf-blue/10 pb-10 md:grid-cols-12">
          <div className="md:col-span-7">
            <span className="eyebrow">{site.leadership.eyebrow}</span>
            <h2 className="display-h2 mt-6 text-usf-blue">{site.leadership.heading}</h2>
          </div>
          <div className="md:col-span-5">
            <p className="text-[15.5px] leading-[1.8] text-usf-muted">
              {site.leadership.description}
            </p>
          </div>
        </div>
            ...
            >
              <div className="relative overflow-hidden border border-usf-blue/10 transition-shadow duration-500 group-hover:shadow-card-hover">
                ...
                <div className="bg-white p-5 sm:p-6">
                  ...
                  <h3 className="mt-2 font-display text-[19px] leading-[1.2] text-usf-blue sm:text-[22px]">
                    {l.name}
                  </h3>
